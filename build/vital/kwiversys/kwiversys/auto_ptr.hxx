...
============================================================================*/
#ifndef kwiversys_auto_ptr_hxx
#define kwiversys_auto_ptr_hxx

#include <kwiversys/Configure.hxx>
...
# define kwiversys_AUTO_PTR_REF 0
# define kwiversys_AUTO_PTR_CONST const
# define kwiversys_AUTO_PTR_CAST(a) cast(a)
#else
# define kwiversys_AUTO_PTR_REF 1
# define kwiversys_AUTO_PTR_CONST
# define kwiversys_AUTO_PTR_CAST(a) a
#endif
...
public:
  ...
  template <class Y>
  auto_ptr(auto_ptr<Y> kwiversys_AUTO_PTR_CONST& a) throw():
    x_(kwiversys_AUTO_PTR_CAST(a).release())
    {
    }
  ...
  template <class Y>
  auto_ptr& operator=(auto_ptr<Y> kwiversys_AUTO_PTR_CONST& a) throw()
    {
    this->reset(kwiversys_AUTO_PTR_CAST(a).release());
    return *this;
    }
  ...
  /** Construct from another auto_ptr holding an object of the same
      ...
      auto_ptr.  */
  auto_ptr(auto_ptr kwiversys_AUTO_PTR_CONST& a) throw():
    x_(kwiversys_AUTO_PTR_CAST(a).release())
    {
    }
  ...
  auto_ptr& operator=(auto_ptr kwiversys_AUTO_PTR_CONST& a) throw()
    {
    this->reset(kwiversys_AUTO_PTR_CAST(a).release());
    return *this;
    }
