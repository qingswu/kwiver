...
============================================================================*/
#ifndef kwiversys_FStream_hxx
#define kwiversys_FStream_hxx
...
#  define kwiversys_FStream_NOEXCEPT _NOEXCEPT
# else
#  define kwiversys_FStream_NOEXCEPT
# endif
  ...
  public:
    ...
    ~basic_ifstream() kwiversys_FStream_NOEXCEPT
    {
      buf_->close();
      delete buf_;
    }
...
class basic_ofstream : public std::basic_ostream<CharType,Traits>
{
  ...
  ~basic_ofstream() kwiversys_FStream_NOEXCEPT
  {
    buf_->close();
    delete buf_;
  }
...
# undef kwiversys_FStream_NOEXCEPT
#else
  using std::ofstream;
  using std::ifstream;
#endif
