...
============================================================================*/
#ifndef kwiversys_Configure_h
#define kwiversys_Configure_h
...
# define kwsys_ns(x) kwiversys##x
# define kwsysEXPORT kwiversys_EXPORT
#endif
...
#define kwiversys_NAME_IS_KWSYS 0

/* Whether Large File Support is requested.  */
#define kwiversys_LFS_REQUESTED 1

/* Whether Large File Support is available.  */
#if kwiversys_LFS_REQUESTED
# define kwiversys_LFS_AVAILABLE 0
#endif
...
#  error "kwiversys/Configure.h must be included before sys/types.h"
# endif
  /* Enable the large file API if it is available.  */
# if kwiversys_LFS_AVAILABLE && \
     !defined(kwiversys_LFS_NO_DEFINES)
#  if !defined(_LARGEFILE_SOURCE) && \
      !defined(kwiversys_LFS_NO_DEFINE_LARGEFILE_SOURCE)
#   define _LARGEFILE_SOURCE
#  endif
#  if !defined(_LARGEFILE64_SOURCE) && \
      !defined(kwiversys_LFS_NO_DEFINE_LARGEFILE64_SOURCE)
#   define _LARGEFILE64_SOURCE
#  endif
#  if !defined(_LARGE_FILES) && \
      !defined(kwiversys_LFS_NO_DEFINE_LARGE_FILES)
#   define _LARGE_FILES
#  endif
#  if !defined(_FILE_OFFSET_BITS) && \
      !defined(kwiversys_LFS_NO_DEFINE_FILE_OFFSET_BITS)
...
#  if defined(kwiversys_EXPORTS)
#   define kwiversys_EXPORT __declspec(dllexport)
#  else
#   define kwiversys_EXPORT __declspec(dllimport)
#  endif
# elif __GNUC__ >= 4
#  define kwiversys_EXPORT __attribute__ ((visibility("default")))
# else
#  define kwiversys_EXPORT
# endif
#else
# define kwiversys_EXPORT
#endif
...
#if !defined(kwiversys_NO_WARNING_ENABLE)
# if defined(_MSC_VER)
...
#if !defined(kwiversys_NO_WARNING_DISABLE)
# if defined(_MSC_VER)
...
/* MSVC 6.0 in release mode will warn about code it produces with its
   ...
   by other compilers.  */
#if !defined(kwiversys_NO_WARNING_DISABLE_BOGUS)
