...
============================================================================*/
#ifndef kwiversys_SharedForward_h
#define kwiversys_SharedForward_h
...
/*
  ...
  #endif
  #define kwiversys_SHARED_FORWARD_DIR_BUILD "/path/to/foo-build/bin"
  #define kwiversys_SHARED_FORWARD_PATH_BUILD "." CONFIG_DIR_POST
  #define kwiversys_SHARED_FORWARD_PATH_INSTALL "../lib/foo-1.2"
  #define kwiversys_SHARED_FORWARD_EXE_BUILD CONFIG_DIR_PRE "foo-real"
  #define kwiversys_SHARED_FORWARD_EXE_INSTALL "../lib/foo-1.2/foo-real"
  #define kwiversys_SHARED_FORWARD_OPTION_COMMAND "--command"
  #define kwiversys_SHARED_FORWARD_OPTION_PRINT "--print"
  #define kwiversys_SHARED_FORWARD_OPTION_LDD "--ldd"
  #if defined(CMAKE_INTDIR)
  # define kwiversys_SHARED_FORWARD_CONFIG_NAME CMAKE_INTDIR
  #endif
  #include <kwiversys/SharedForward.h>
  int main(int argc, char** argv)
  {
    return kwiversys_shared_forward_to_real(argc, argv);
  }
  ...
  #define kwiversys_SHARED_FORWARD_PATH_BUILD \
          "." CONFIG_DIR_POST, "/path/to/bar-build" CONFIG_DIR_POST
  #define kwiversys_SHARED_FORWARD_PATH_INSTALL \
...
#if !defined(kwiversys_SHARED_FORWARD_DIR_BUILD)
# error "Must define kwiversys_SHARED_FORWARD_DIR_BUILD"
#endif
#if !defined(KWSYS_SHARED_FORWARD_DIR_BUILD)
# define KWSYS_SHARED_FORWARD_DIR_BUILD kwiversys_SHARED_FORWARD_DIR_BUILD
#endif

/* Library search path for build tree.  */
#if !defined(kwiversys_SHARED_FORWARD_PATH_BUILD)
# error "Must define kwiversys_SHARED_FORWARD_PATH_BUILD"
#endif
#if !defined(KWSYS_SHARED_FORWARD_PATH_BUILD)
# define KWSYS_SHARED_FORWARD_PATH_BUILD kwiversys_SHARED_FORWARD_PATH_BUILD
#endif

/* Library search path for install tree.  */
#if !defined(kwiversys_SHARED_FORWARD_PATH_INSTALL)
# error "Must define kwiversys_SHARED_FORWARD_PATH_INSTALL"
#endif
#if !defined(KWSYS_SHARED_FORWARD_PATH_INSTALL)
# define KWSYS_SHARED_FORWARD_PATH_INSTALL kwiversys_SHARED_FORWARD_PATH_INSTALL
#endif

/* The real executable to which to forward in the build tree.  */
#if !defined(kwiversys_SHARED_FORWARD_EXE_BUILD)
# error "Must define kwiversys_SHARED_FORWARD_EXE_BUILD"
#endif
#if !defined(KWSYS_SHARED_FORWARD_EXE_BUILD)
# define KWSYS_SHARED_FORWARD_EXE_BUILD kwiversys_SHARED_FORWARD_EXE_BUILD
#endif

/* The real executable to which to forward in the install tree.  */
#if !defined(kwiversys_SHARED_FORWARD_EXE_INSTALL)
# error "Must define kwiversys_SHARED_FORWARD_EXE_INSTALL"
#endif
#if !defined(KWSYS_SHARED_FORWARD_EXE_INSTALL)
# define KWSYS_SHARED_FORWARD_EXE_INSTALL kwiversys_SHARED_FORWARD_EXE_INSTALL
#endif

/* The configuration name with which this executable was built (Debug/Release). */
#if defined(kwiversys_SHARED_FORWARD_CONFIG_NAME)
# define KWSYS_SHARED_FORWARD_CONFIG_NAME kwiversys_SHARED_FORWARD_CONFIG_NAME
#else
# undef KWSYS_SHARED_FORWARD_CONFIG_NAME
#endif

/* Create command line option to replace executable.  */
#if defined(kwiversys_SHARED_FORWARD_OPTION_COMMAND)
# if !defined(KWSYS_SHARED_FORWARD_OPTION_COMMAND)
#  define KWSYS_SHARED_FORWARD_OPTION_COMMAND kwiversys_SHARED_FORWARD_OPTION_COMMAND
# endif
#else
...
#if defined(kwiversys_SHARED_FORWARD_OPTION_PRINT)
# if !defined(KWSYS_SHARED_FORWARD_OPTION_PRINT)
#  define KWSYS_SHARED_FORWARD_OPTION_PRINT kwiversys_SHARED_FORWARD_OPTION_PRINT
# endif
#else
...
#if defined(kwiversys_SHARED_FORWARD_OPTION_LDD)
# if !defined(KWSYS_SHARED_FORWARD_OPTION_LDD)
#  define KWSYS_SHARED_FORWARD_OPTION_LDD kwiversys_SHARED_FORWARD_OPTION_LDD
# endif
#else
...
static int kwiversys_shared_forward_to_real(int argc, char** argv_in)
{
...
#else
# error "kwiversys/SharedForward.h should be included only once."
#endif
